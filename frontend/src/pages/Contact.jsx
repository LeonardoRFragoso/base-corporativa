    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900">
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4 bg-white dark:bg-neutral-800 p-6 rounded-lg shadow-soft">
            <div>
              <div className="text-sm text-neutral-500 dark:text-neutral-500">E-mail</div>
          ...
          <form onSubmit={submit} className="bg-white dark:bg-neutral-800 p-6 rounded-lg shadow-soft space-y-4">
            <div>
              <label className="block text-sm text-neutral-700 dark:text-neutral-300 mb-1">Nome</label>
              <input
                type="text"
                value={form.name}
                onChange={(e) => setForm({ ...form, name: e.target.value })}
                required
                className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-2 focus:ring-primary-950 focus:border-transparent"
              />
            </div>
            <div>
              <label className="block text-sm text-neutral-700 dark:text-neutral-300 mb-1">E-mail</label>
              <input
                type="email"
                value={form.email}
            ...
            <div>
              <label className="block text-sm text-neutral-700 dark:text-neutral-300 mb-1">Telefone (opcional)</label>
              <input
                type="tel"
                value={form.phone}
            ...
            <div>
              <label className="block text-sm text-neutral-700 dark:text-neutral-300 mb-1">Assunto (opcional)</label>
              <input
                type="text"
                value={form.subject}
            ...
            <div>
              <label className="block text-sm text-neutral-700 dark:text-neutral-300 mb-1">Mensagem</label>
              <textarea
                rows="4"
                value={form.message}
