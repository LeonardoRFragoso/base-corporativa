            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-lg shadow-soft p-6">
                  ...
                  <div className="space-y-4">
                    {(order.items || []).map((item, index) => (
                      <div key={item.id || index} className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-soft p-6">
                  ...
                  <div className="space-y-3">
                    {order.shipping_carrier && (
                      <div>
                        <div className="text-sm text-neutral-500">Transportadora</div>
                ...
                <div className="bg-white rounded-lg shadow-soft p-6">
                  ...
                  <div className="space-y-3">
                    <div>
                      <div className="text-sm text-neutral-500">Método</div>
                      <div className="font-medium">Mercado Pago</div>
                    </div>
                    {order.mp_payment_id && (
                      <div>
                        <div className="text-sm text-neutral-500">ID do Pagamento</div>
                        <div className="font-medium text-sm">{order.mp_payment_id}</div>
                      </div>
                    )}
                    {order.mp_status && (
                      <div>
                        <div className="text-sm text-neutral-500">Status MP</div>
                        <div className="font-medium">{order.mp_status}</div>
                      </div>
                    )}
                    {order.external_reference && (
                      <div>
                        <div className="text-sm text-neutral-500">Referência</div>
