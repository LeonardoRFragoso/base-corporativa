        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-8">
          ...
          {pixData.qr_code_base64 && (
            <div className="flex flex-col items-center">
              <div className="bg-white p-6 rounded-2xl border-4 border-neutral-200 shadow-lg">
                <img 
          ...
          <div className="text-center py-6 bg-gradient-to-r from-primary-50 to-bronze-50 rounded-xl">
            <p className="text-sm text-neutral-600 mb-2">Valor a pagar</p>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <input
                  ...
                  readOnly
                  className="flex-1 px-4 py-3 border-2 border-neutral-300 rounded-xl bg-neutral-50 font-mono text-sm"
                />
                <button
          ...
          <div className="border-t-2 border-neutral-200 pt-6">
            <h3 className="text-lg font-semibold text-neutral-900 mb-4">Informações do pedido</h3>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-neutral-600">Número do pedido:</span>
                <span className="font-semibold text-neutral-900">{pixData.external_reference}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-neutral-600">ID do pagamento:</span>
                <span className="font-mono text-xs text-neutral-700">{pixData.payment_id}</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              to="/catalog"
              className="flex-1 py-4 px-6 border-2 border-neutral-300 text-neutral-700 font-semibold rounded-xl hover:bg-neutral-50 hover:border-neutral-400 transition-all text-center"
            >
              Voltar para a loja
            </Link>
          </div>
